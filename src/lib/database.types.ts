  ...
  public: {
    ...
    Functions: {
      ...
      get_my_permissions: {
        ...
        Returns: { permission_slug: string }[]
      }
      has_permission: {
      ...
      get_user_roles: {
        Args: Record<string, never>
        Returns: { role_id: string; role_slug: string; role_name: string }[]
      }
      write_audit_log: {
        Args: { p_action: string; p_resource: string; p_resource_id?: string; p_old_value?: unknown; p_new_value?: unknown; p_severity?: string }
        Returns: string
      }
      user_has_permission: {
