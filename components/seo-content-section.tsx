          ...
          <div className="mt-8 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
            {FEATURES.map((f) => (
              <div key={f.title} className="lift-card group rounded-2xl border border-border/60 bg-card/60 p-6 backdrop-blur-sm">
                <div className="flex h-11 w-11 items-center justify-center rounded-xl bg-primary/15 ring-1 ring-primary/30 transition-all duration-300 group-hover:-translate-y-1 group-hover:scale-110 group-hover:bg-primary/25 group-hover:shadow-[0_8px_20px_rgba(212,160,23,0.2)]">
