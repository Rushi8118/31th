...
export const metadata: Metadata = {
  title: "Post Study Work Visa: Complete 2026 Guide (10+ Countries Compared) | Siddhivinayak Overseas",
  description:
    "Complete guide to post-study work visas in UK, Australia, Canada, New Zealand, Germany, Ireland, France & more. Eligibility, process & PR pathways for international students.",
  keywords: [
    ...
    "graduate route visa",
    "PSW visa",
    "work after study abroad",
    "post study work permit",
    "international students work visa",
    "study to work visa transition",
  ],
}
...
const COUNTRIES = [
  {
    ...
    eligibility: "Any UK degree",
    pr: "Yes (Skilled Worker)",
    href: "/post-study-work-visa/uk",
  },
  {
    flag: "🇦🇺",
    name: "Australia",
    visa: "Subclass 485",
    duration: "2-4 years",
    eligibility: "Bachelor's or higher",
    pr: "Yes (strong pathway)",
    href: "/post-study-work-visa/australia",
  },
  {
    flag: "🇨🇦",
    name: "Canada",
    ...
    eligibility: "8+ month program at DLI",
    pr: "Yes (CEC pathway)",
    href: "/post-study-work-visa/canada",
  },
  {
    flag: "🇳🇿",
    name: "New Zealand",
    ...
    duration: "1-3 years",
    eligibility: "Level 7+ qualification",
    pr: "Yes (Skilled Migrant)",
    href: "/post-study-work-visa/new-zealand",
  },
  {
    flag: "🇩🇪",
    name: "Germany",
    ...
    duration: "18 months",
    eligibility: "German university degree",
    pr: "Yes (after 2 years work)",
    href: "/post-study-work-visa/germany",
  },
  {
    flag: "🇮🇪",
    name: "Ireland",
    visa: "Third Level Graduate Scheme",
    duration: "1-2 years",
    eligibility: "Irish degree",
    pr: "Yes (Critical Skills)",
    href: "/post-study-work-visa/ireland",
  },
  {
    flag: "🇫🇷",
    name: "France",
    visa: "APS Visa",
    duration: "12 months",
    eligibility: "Master's or equivalent",
    pr: "Yes (Talent Passport)",
    href: "/post-study-work-visa/france",
  },
]
                ...
                <tbody>
                  {COUNTRIES.map((c) => (
                    <tr key={c.name} className="border-b border-border/40 transition hover:bg-primary/5">
                      <td className="p-3">
                        <Link href={c.href} className="flex items-center gap-2 text-sm font-medium text-foreground hover:text-primary">
              ...
              {[
                {
                  icon: Briefcase,
                  title: "Career Goals",
                  desc: "Consider which countries have strong job markets in your field. Tech graduates may prefer the UK or Germany, while healthcare professionals often find opportunities in Australia and Canada.",
                },
                {
                  icon: Award,
                  title: "PR Timeline",
                  desc: "If permanent residency is your goal, Canada's CEC pathway and Australia's skilled migration offer the clearest routes. The UK and Germany also provide strong PR options after a few years of work.",
                },
                {
                  icon: Clock,
                  title: "Visa Duration",
                  desc: "Australia offers up to 4 years for PhD graduates, Canada up to 3 years, and the UK 2 years (3 for PhD). Choose based on how much time you need to gain experience and secure sponsorship.",
                },
              ].map((item) => (
            ...
            <div className="grid grid-cols-1 gap-12 lg:grid-cols-2">
              <div>
                ...
                <ul className="mt-6 space-y-4">
                  {[
                    {
                      title: "Applying After Study Visa Expires",
                      desc: "Most countries require you to apply within 60-90 days of graduation. Missing this deadline means losing eligibility permanently.",
                    },
                    {
                      title: "Incomplete Academic Documentation",
                      desc: "Transcripts and completion letters must be certified by your university. Uncertified copies are the second most common cause of rejection.",
                    },
                    {
                      title: "Insufficient English Language Scores",
                      desc: "Many students assume older test scores are valid. Check language validity periods — most countries require scores within the last 2-3 years.",
                    },
                    {
                      title: "Applying for the Wrong Visa Stream",
                      desc: "Each country has multiple post-study streams. Applying for the wrong one can result in rejection even if you meet all requirements.",
                    },
                  ].map((item) => (
                    <li key={item.title} className="flex items-start gap-3">
                      <div className="flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-destructive/15 text-xs font-bold text-destructive">
                        !
                      </div>
                      <div>
              ...
              {[
                {
                  name: "Priya M.",
                  from: "Mumbai",
                  study: "Master's in IT — University of Melbourne",
                  outcome: "3-year post-study visa granted, now on PR pathway",
                },
                {
                  name: "Rahul K.",
                  from: "Delhi",
                  study: "Bachelor's in Business — Monash University",
                  outcome: "2-year visa granted, employer sponsored in Year 2",
                },
                {
                  name: "Ananya S.",
                  from: "Bangalore",
                  study: "Master's in Finance — University of Birmingham",
                  outcome: "Graduate Route visa granted, working in London",
                },
              ].map((s) => (
          ...
          <div className="mx-auto max-w-7xl px-4 md:px-6">
            <div className="rounded-3xl border border-primary/30 bg-primary/5 p-8 text-center md:p-12">
              ...
              <p className="mt-6 text-sm text-muted-foreground">
                Also explore: <Link href="/study-in-uk" className="text-primary hover:underline">Study in UK</Link> &middot; <Link href="/study-in-australia" className="text-primary hover:underline">Study in Australia</Link> &middot; <Link href="/study-in-canada" className="text-primary hover:underline">Study in Canada</Link>
              </p>
            </div>
          </div>
        </section>
